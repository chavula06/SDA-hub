...
const DEFAULT_PAGE_CONTENT = {
    site: {
        title: 'SDA Hub Connect Zambia',
        heroHeadline: 'Faith. Community. Growth.',
        heroText: 'Rooted in Scripture, serving in love, and creating a calm space for reflection, prayer, and fellowship across the SDA community in Kawambwa.',
        heroImage: 'images/hero-church.svg'
    },
    quickAccess: [
        {
            icon: 'assets/icons/bible.svg',
            title: 'Sermons',
            description: 'Listen to uplifting messages and teachings for daily spiritual growth.'
        },
        {
            icon: 'assets/icons/prayer.svg',
            title: 'Prayer Wall',
            description: 'Share your requests and pray for one another with confidence.'
        },
        {
            icon: 'assets/icons/event.svg',
            title: 'Events',
            description: 'Stay updated on church programs, meetings, and outreach activities.'
        }
    ],
    sermons: [
        {
            title: 'Walking in Faith',
            speaker: 'Pastor Ephraim Musonda',
            date: 'June 15, 2026',
            summary: 'A reflection on trusting God in every season of life.',
        ...
        },
        {
            ...
            speaker: 'Elder Chileshe Mweemba',
            date: 'June 8, 2026',
            summary: 'Finding strength and peace through prayer and perseverance.',
            image: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=900&q=80',
            audio: ''
        },
        {
            title: 'The Power of Community',
            speaker: 'Pastor Rose Banda',
            date: 'June 1, 2026',
            summary: 'How fellowship strengthens faith and encourages service.',
    ...
    prayerRequests: [
        {
            name: 'Grace',
            text: 'Please pray for healing and peace in my family.',
            count: 12,
            image: 'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?auto=format&fit=crop&w=800&q=80'
        },
        {
            name: 'Anonymous',
            text: 'Pray for wisdom, guidance, and strength in my daily work.',
            count: 7,
    ...
    events: [
        {
            ...
            description: 'Come and join us for fellowship, prayer, and Scripture meditation.',
            image: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=900&q=80'
        },
        {
            title: 'Community Outreach',
            date: 'Saturday, 9:00 AM',
            location: 'Kawambwa Town Center',
            description: 'A day of service, encouragement, and practical support for families.',
    ...
    resources: [
        {
            ...
            items: ['Daily Devotionals', 'Bible Reading Plans', 'Study Guides']
        },
        {
            category: 'Music',
            items: ['Hymn Book', 'Choir Rehearsal Notes', 'Worship Playlists']
        },
        {
            category: 'Ministry',
            items: ['Youth Resources', "Children's Lessons", 'Prayer Materials']
        }
    ],
    donation: {
        mtn: '0971081002',
        ...
        bank: {
            name: 'Zanaco',
            account: 'Account details will be shared on request'
        }
    },
    contact: {
        email: 'ephraimmusonda450@gmail.com',
        phone: '0971081002',
        whatsapp: '0971081002',
        location: 'Kawambwa, Zambia'
    }
};
...
async function fetchPageContent() {
    ...
    try {
        ...
        console.warn(error.message || 'Unable to load content.json. Using fallback content.');
...
function renderPrayerRequests() {
    ...
    prayerRequestsGrid.innerHTML = pageContent.prayerRequests.map(request => `
        <div class="prayer-card">
            <div class="prayer-card-image" style="background-image: url('${request.image || 'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?auto=format&fit=crop&w=800&q=80'}')"></div>
...
function renderEvents() {
    eventsGrid.innerHTML = pageContent.events.map(event => `
        <div class="event-card">
            <img src="${event.image || 'https://images.unsplash.com/photo-1494526585095-c41746248156?auto=format&fit=crop&w=900&q=80'}" alt="${event.title}" class="event-img">
...
function renderContact() {
    const phone = pageContent.contact.phone || '';
    const whatsapp = pageContent.contact.whatsapp || phone;
    const whatsappNumber = String(whatsapp).replace(/\D/g, '');
    const whatsappLabel = whatsappNumber ? `WhatsApp: ${whatsappNumber}` : 'Chat with us on WhatsApp';
    ...
    contactWhatsappEl.href = whatsappNumber ? `https://wa.me/${whatsappNumber}` : '#';
    contactWhatsappEl.textContent = whatsappLabel;
